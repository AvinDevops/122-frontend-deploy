...
resource "null_resource" "frontend" {
  triggers = {
    instance_id = module.frontend.id # whenever new frontend id is created this null resource will trigger
  }
...
## creating  frontend target group ##
...
## creating frontend launch template ##
...
## creating frontend auto sacling group ##
...
## creating alb listener for frontend ## 
